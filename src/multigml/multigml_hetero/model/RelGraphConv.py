...
from dgl.nn.pytorch.utils import WeightBasis
...
class RelGraphConvLayer(nn.Module):
    ...
    def __init__(self,
        ...
        self.use_basis = self.num_bases < len(self.rel_names) and weight
        if self.use_weight:
            if self.use_basis:
        ...
        # bias
        if bias:
            self.h_bias = nn.Parameter(th.Tensor(self.out_feat))
